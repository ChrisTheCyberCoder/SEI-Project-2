...
function GeneralKnowledge() {
  ...
  React.useEffect(() => {
    ...
    const baseUrl = 'https://opentdb.com/api.php?amount=50&category=9&type=multiple' 
    const getData = async () => {
      try {
    ...
    if (randomNumber === 0) {
      return (
        <>
          ...
          {fiftyFiftyActive ? null : <h4 data-id="wrong" onClick={handleClick} className="choice"> A. {quizzes[nextQuestion].incorrect_answers[0]} </h4>}
          <h4 data-id="wrong" onClick={handleClick} className="choice"> B. {quizzes[nextQuestion].incorrect_answers[1]} </h4>
          {fiftyFiftyActive ? null : <h4 data-id="wrong" onClick={handleClick} className="choice"> C. {quizzes[nextQuestion].incorrect_answers[2]} </h4>}
      ...
      return (
        <>
          ...
          {fiftyFiftyActive ? null : <h4 data-id="wrong" onClick={handleClick} className="choice"> D. {quizzes[nextQuestion].incorrect_answers[2]} </h4>}
        </>
      )
      ...
      return (
        <>
          ...
          {fiftyFiftyActive ? null : <h4 data-id="wrong" onClick={handleClick} className="choice"> B. {quizzes[nextQuestion].incorrect_answers[1]} </h4>}
      ...
      return (
        <>
          ...
          {fiftyFiftyActive ? null : <h4 data-id="wrong" onClick={handleClick} className="choice"> C. {quizzes[nextQuestion].incorrect_answers[1]} </h4>}
          {fiftyFiftyActive ? null : <h4 data-id="wrong" onClick={handleClick} className="choice"> D. {quizzes[nextQuestion].incorrect_answers[2]} </h4>} 
        </>
      )
    }
  ...
  return (
    <div className="mainContainer generalknowledge">
      
      <h1 className="right">Right:<span>{right}</span></h1>
      <h1 className="wrong">Wrong:<span>{wrong}</span></h1>
      
      <h1 className="header">Quiz: General Knowledge</h1>
